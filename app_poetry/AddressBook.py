...
class AddressBook(UserList):
    ...
    def save(self, file_name):
        try:
            ...
            logging.error(f"Error while saving address book: {e}")
            print(f"Error: {e}")
    ...
    def load(self, file_name):
        try:
            ...
            logging.error(f"Error while loading address book: {e}")
            print(f"Error: {e}")
        except Exception as e:
            logging.error(f"Unexpected error while loading address book: {e}")
    ...
    def edit(self, contact_name, parameter, new_value):
        ...
        try:
            ...
            logging.error(f"Error while editing contact: {e}")
            print(f"Error: {e}")
        except NameError as e:
            logging.error(f"Error while editing contact: {e}")
            print(f"Error: {e}")
        except Exception as e:
            logging.error(f"Unexpected error while editing contact: {e}")
            print(f"Unexpected error: {e}")
        else:
    ...
    def remove(self, pattern):
        ...
        try:
            ...
            logging.error(f"Unexpected error while removing contact: {e}")
            print(f"Unexpected error: {e}")
        return flag
